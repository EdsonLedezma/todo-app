...
const PrivacyNotice: React.FC<PrivacyNoticeProps> = ({ onAccept }) => {
    return (
        <Card className="w-full max-w-4xl mx-auto my-8">
            <CardHeader>
                <CardTitle className="text-2xl font-bold text-center">Aviso de Privacidad y Confidencialidad</CardTitle>
            </CardHeader>
            <CardContent>
                <ScrollArea className="h-[400px] w-full rounded-md border p-4">
                    <div className="space-y-4">
                        <section>
                            ...
                            <p>
                                Este Aviso de Privacidad y Confidencialidad (en adelante, el "Aviso") se emite en cumplimiento con la
                                Ley Federal de Protección de Datos Personales en Posesión de los Particulares y su Reglamento (en
                                adelante, la "Ley"), así como otras leyes y regulaciones aplicables en México.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>
                                ...
                                personales contra el acceso no autorizado, alteración, divulgación o destrucción, de conformidad con la
                        ...
                        <section>
                            ...
                            <p>
                                No transferimos sus datos personales a terceros, excepto en los casos previstos por la Ley o cuando sea
                                necesario para la prestación de nuestros servicios, siempre con su consentimiento.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>
                                El contenido generado por los usuarios en la Aplicación está protegido por la Ley Federal del Derecho de
                                Autor. Los usuarios mantienen la propiedad de su contenido, pero otorgan a la Aplicación una licencia no
                                exclusiva para usar, almacenar y procesar dicho contenido con el fin de proporcionar el servicio.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p>
                                La Aplicación se proporciona "tal cual" y "según disponibilidad". No garantizamos que la Aplicación esté
                                libre de errores o que funcione sin interrupciones. No nos hacemos responsables de cualquier daño
                                directo, indirecto, incidental, consecuente o especial que pueda surgir del uso o la imposibilidad de
                        ...
                        <section>
                            ...
                            <p>
                                Nos reservamos el derecho de modificar este Aviso en cualquier momento. Cualquier cambio será notificado
                        ...
                        <section>
                            ...
                            <p>
                                Si tiene alguna pregunta sobre este Aviso o sobre nuestras prácticas de privacidad, por favor contacte a
                                [edsonmon985@gmail.com].
                            </p>
                        </section>
                    </div>
                </ScrollArea>
